package dio;
/*
16.1. Faça um programa que leia um número inteiro digitado pelo usuário e informe na tela se o número é negativo (menor do que zero) ou se é positivo (maior ou igual a zero).
